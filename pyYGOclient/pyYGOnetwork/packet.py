...
from pyYGO.enums import Phase
from pyYGO.cardstatus import Location, Position
...
class Packet:
    ...
    def write(self, content: Union[str, int, bytes, bytearray, bool], * , byte_size: int=4) -> None:
